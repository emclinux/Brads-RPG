...
class Fighter:
    ...
    def __init__(self, hp, defense, power, dodge, death_function=None):
        self.max_hp = hp
        self.hp = hp
    ...
    def attack(self, target):
        ...
        dodged = 0
        if libtcod.random_get_int(0, 1, 100) <= self.dodge:
            damage = 0
            dodged = 1
        ...
        if damage > 0:
            ...
            message(self.owner.name.capitalize() + ' dodges ' + target.name + '\'s attack ')
        elif damage <= 0 and dodged == 0:
    ...
    for i in range(num_monsters):
        ...
        if not is_blocked(x, y):
            if libtcod.random_get_int(0, 0, 100) < 80:  #80% chance of getting an orc
                #create an orc
                fighter_component = Fighter(hp=10, defense=0, power=3, dodge=5, death_function=monster_death)
                ...
                #create a troll
                fighter_component = Fighter(hp=16, defense=1, power=4, dodge=7, death_function=monster_death)
                ai_component = BasicMonster()
...
def handle_keys():
    ...
    elif key.vk == libtcod.KEY_CONTROL and 'r':
        return 'restart'
...
libtcod.console_init_root(SCREEN_WIDTH, SCREEN_HEIGHT, 'Brads\'s RPG', False)
libtcod.sys_set_fps(LIMIT_FPS)
con = libtcod.console_new(MAP_WIDTH, MAP_HEIGHT)
panel = libtcod.console_new(SCREEN_WIDTH, PANEL_HEIGHT)

#create object representing the player
fighter_component = Fighter(hp=30, defense=2, power=5, dodge=15, death_function=player_death)
...
message('Welcome stranger! This is Brad\'s RPG. <Insert Story Here Please!>', libtcod.blue)
...
while not libtcod.console_is_window_closed():
    ...
    if player_action == 'exit':
        break
    elif player_action == 'restart':
        print "Need code for this"
